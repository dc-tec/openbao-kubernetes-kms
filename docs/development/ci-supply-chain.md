...
Current validation uses OpenBao `2.5.5`, Kubernetes KMS v2, Linux
...
Install-time verification is documented in [Getting Started: Install](/getting-started/install/#verify-release-artifacts).
