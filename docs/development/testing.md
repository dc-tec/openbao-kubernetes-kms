...
| Failure injection | Exercise OpenBao outage, sealed state, failover, bad policy, expired or identity-drifted auth material, missing Transit key, stale socket, and startup failures. | provider failure and high-availability E2E lanes |
